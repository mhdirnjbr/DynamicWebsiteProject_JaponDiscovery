...
?>
				        ...
				        <th><a href="Kanto.php?lieu=Kanto">Kanto -></a><br></th>
				        </tr>
				    </thead>
					</table>	
				</form>
...
<section class="horizontal-scroll">
				                    ...
				                    <div class="card">
											<input type="image" name="image1" value="image1" alt="image1" src="ryusendo.jpg" width ="300px">
											<p> Cave Ryusendo </p>
									</div>
				                    ...
				                    <div class="card">
											<input type="image" name="image2" value="image2" alt="image2" src="zao.jpg" width ="300px">
											<p>Le mont Zao</p>
									</div>
				                    ...
				                    <div class="card">
											<input type="image" name="image3" value="image3" alt="image3" src="yamadera.jpg" width ="300px">
											<p>Temple Yamadera</p>
									</div>
