	...
	?>
		<form action ="resultat.php"method ="post" >
			...
			<input type="radio" name="q5" id="case1" value = <?php echo "$rep2"."points" ?> >
			...
			<label for="case2"><?php 
				...
				<input type="radio" name="q5" id="case2" value = <?php echo "$rep2"."points" ?> /> 
			<br><br>	
			 ...
			 <label for="case3"><?php 
				...
				?></label>
					<input type="radio" name="q5" id="case3"value = <?php echo "$rep2"."points" ?> />
			 <br><br>	
			...
			?></label>
			<input type="radio" name="q5" id="case4" value = <?php echo "$rep2"."points" ?> /> 
		<br><br>	
